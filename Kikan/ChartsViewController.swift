...
class ChartsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let circleViewGenerator = {(chartPointModel: ChartPointLayerModel, layer: ChartPointsLayer, chart: Chart) -> UIView? in
            ...
            let v = ChartPointTextCircleView(chartPoint: chartPoint, center: screenLoc, diameter: 30, cornerRadius: 15, borderWidth: 1, font: ExamplesDefaults.fontWithSize(8))
            v.viewTapped = {view in
                ...
                infoView.font = ExamplesDefaults.fontWithSize(12)
